...
<table width="1025" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td   align="center" >
	<div style="height:27px; background-image:url(images/bphome_03.jpg)" ><jdoc:include type="modules" name="MenuSuperior" />
...
<br>
 ...
 <h1 align="center" style="font-size:30px"> </h1>
  ...
  <p>
    ...
    <p align="right">
      <label style=" width:300px" for="cv">Nivel  Area oAdministrativa que le interesa  </label><BR>
      <select style="width:150px; margin-right:15px;"  id="genero" name="nivel">
       <option id="genero" >Prescolar</option>
       <option id="genero">Primaria</option>
       <option id="genero" >Secundaria</option>
       <option id="genero">Preparatoria</option>
       <option id="genero">Areas Administrativas</option>
       
     </select><br>
    </p>
    
      <label style=" width:400px" for="cv">
        <div align="left">Asignatura o Actividad Administrativa Deseada</div>
      </label>
      <div align="right"><BR>
        <input name="asignatura"   type="text" required  id="asignatura" style="margin-right:15px; width:330px;" maxlength="200"  >
        
      </div>
      <p align="center">
        <label style=" width:250px" for="cv">Curriculum Vitae: (.pdf  .doc .docx)</label>
  ...
  <img src="img/banner-exalumnos.png" width="300px"  >
   <h1 style=" color:#000;" align="center">LOGIN ADMINISTRADOR</h1><br>
 <div style="width:240px;  color:#000;padding: 0px 0px 0px 60px;"> 
  ...
  <p style="color:#F00;">
  <?php if(isset($_REQUEST['er'])){echo "Usuario o Contraseña Invalido";} ?>
  </p></div></div>
</div>
